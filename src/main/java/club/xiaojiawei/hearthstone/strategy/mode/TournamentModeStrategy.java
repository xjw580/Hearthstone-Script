...
import static club.xiaojiawei.hearthstone.utils.MouseUtil.REST_TIME;
 ...
 */
@Slf4j
public class TournamentModeStrategy extends ModeStrategy {
...
//                    SystemUtil.notice("无法匹配成功，准备重启游戏");
//                    SystemUtil.frontWindow(Core.getGameHWND());
