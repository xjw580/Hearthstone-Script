...
import club.xiaojiawei.hearthstone.enums.DeckTypeEnum;
...
import static club.xiaojiawei.hearthstone.constant.GameMapConst.DECK_MAP;
import static club.xiaojiawei.hearthstone.constant.GameMapConst.DECK_TYPE_MAP;
import static club.xiaojiawei.hearthstone.constant.SystemConst.*;
import static club.xiaojiawei.hearthstone.enums.DeckTypeEnum.GENERAL;
...
public class TournamentAbstractModeStrategy extends AbstractModeStrategy {
    ...
    public void selectDeck(WinDef.RECT gameRECT){
        ...
        WebSocketServer.sendAllMessage(WsResult.ofDeckType(deck));
        Deck.setDeck(deck);
