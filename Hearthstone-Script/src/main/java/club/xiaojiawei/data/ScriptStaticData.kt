...
object ScriptStaticData {
    ...
    init {
        War.addResetCallback(Runnable { CARD_AREA_MAP.clear() })
...
//        }
        ...
        val tagTempMap: MutableMap<String?, TagEnum?> = HashMap<String?, TagEnum?>(TagEnum.entries.size)
        ...
        val cardRaceTempMap: MutableMap<String?, CardRaceEnum?> =
            HashMap<String?, CardRaceEnum?>(CardRaceEnum.entries.size)
        ...
        val cardTypeTempMap: MutableMap<String?, CardTypeEnum?> =
            HashMap<String?, CardTypeEnum?>(CardTypeEnum.entries.size)
