...
@Slf4j
@Component
public class PackopeningModeStrategy extends AbstractModeStrategy<Object> implements ModeTaskCloser {

    public static final GameRect BACK_RECT = new GameRect(0.4040D, 0.4558D, 0.4058D, 0.4376D);
